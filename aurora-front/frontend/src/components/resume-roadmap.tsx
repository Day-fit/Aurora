export function ResumeRoadmapElement({text, image, description} : {text: string, image?: string, description: string}) {
    return(
        <section className="flex flex-col md:flex-row items-center gap-8 p-8">
            ...
            <div className="flex flex-col gap-4 w-full md:w-1/2">
                ...
                <p className="text-text-dark text-opacity-90 leading-relaxed">{description}</p>
            </div>
        </section>
    )
}
    ...
    const resumeSteps = [
        {
            ...
            description: "Set up your professional profile with basic information, contact details, and career objectives.",
            icon: "📝"
        },
        {
            id: 2,
            title: "Add Experience & Skills",
            description: "Input your work history, education, and showcase your technical and soft skills.",
            icon: "💼"
        },
        {
            id: 3,
            title: "Generate & Download",
            description: "Choose from professional templates and download your polished resume in PDF format.",
            icon: "⬇️"
        }
    ];

    return (
        <section className="bg-bg-dark text-text-dark py-16 px-6 md:px-10">
