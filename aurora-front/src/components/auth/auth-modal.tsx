  ...
  return (
    ...
    >
      <Dialog.Portal>
        ...
        >
          <motion.div
            className="fixed top-24 sm:top-28 left-1/2 -translate-x-1/2 bg-main-dark text-text-dark rounded-xl p-6 sm:p-8 shadow-2xl max-w-lg w-[92vw] sm:w-[90vw] max-h-[calc(100vh-8rem)] overflow-y-auto border border-gray-700"
