...
export default function Page() {
  ...
  return (
    <section className="rounded-xl p-10 md:p-16">
      <div className="bg-main-dark/80 backdrop-blur-sm rounded-xl p-8 md:p-12 flex flex-col md:flex-row gap-10 text-text-dark shadow-2xl items-center justify-center">
        {!createdCvs ? (
          ...
          <>
            <header className="flex flex-col sm:flex-row items-start sm:items-center justify-between w-full mb-6">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight">
                Your CVs
              </h1>
              <Link
                href="/create-cv"
                className="mt-4 sm:mt-0 text-lg font-semibold text-aurora-blue-dark hover:underline"
              >
                Create New CV
              </Link>
            </header>
